...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="htmlHead">
        <head>
            <title>
                <xsl:value-of select="testng:getVariableSafe($testNgXslt.reportTitle, 'TestNG Results(Changed from htmlHead')"/>
            </title>
    ...
    <xsl:template match="/testng-results">
                ...
                <svg id="graphzone" preserveAspectRatio="xMidYMid meet" x="0" y="0">
                    ...
                    <g style="stroke:black;stroke-width:1" transform="translate(450,150)">
                        ...
                        <xsl:if test="($failedCount div $totalCount) > 0">
                            <a xlink:href="testng_SeleniumSuit.html" target="content"><g style="fill:red"
						...
						<a xlink:href="testng_SeleniumSuit.html" target="content">
        ...
        <xsl:result-document href="{testng:absolutePath('overview.html')}" format="xhtml">
            <html xmlns="http://www.w3.org/1999/xhtml">
                <xsl:call-template name="htmlHead"/>
                <body>
                    <h2>Complete Execution Report..</h2> <!--Test suites overview-->
                    <table width="100%">
                        <tr>
